...
title-slide-attributes:
  ...
  # Match the ordering: top image is 150px, bottom image covers the full slide
  data-background-size: "50px, cover"
  # Match the ordering: top image is in top-right corner, bottom image is centered
  data-background-position: "bottom 20px left 300px, center"
...
```{r}
knitr::include_graphics("images/02-overview/reg_gpt.png")
```
