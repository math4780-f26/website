...
- If $Y_1 \sim N(\mu_1, \sigma_1^2)$ and $Y_2 \sim N(\mu_2, \sigma_2^2)$ and $Y_1$ and $Y_2$ are [*independent*]{.green}. Then for $a, b \in \mathbf{R}$,
$$\textcolor{blue}{aY_1 + bY_2 \sim N\left(a\mu_1+b\mu_2, a^2\sigma_1^2 + b^2\sigma_2^2\right)}$$

. . .


- Example. $Y_1 \sim N(1, 2)$ and $Y_2 \sim N(2, 1)$, and $Y_1 \perp Y_2$. Then 
$$2Y_1 - 3Y_2 \sim N\left(2(1) - 3(2), 2^2(2) + 3^2(1)\right) = N(-4, 17)$$
