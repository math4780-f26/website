...
viewof sampleno = Scrubber(d3.ticks(1, 1000, 1000), {
  ...
  delay: 1000,
  initial: 199,
  format: x => `dataset number: ${x.toFixed(0)}`
})
```
...
plt = Plot.plot({
  width: 1200, // or a dynamic value based on `width` variable
  height: 800,
  style: {fontSize: "16px"},
  ...
  marks: [
    ...
    Plot.dot(data_estimates[0][sampleno-1], {x: "x", y: "y", strokeOpacity: 0.5, r: 5, fill: colors[0]}),
    Plot.line(
